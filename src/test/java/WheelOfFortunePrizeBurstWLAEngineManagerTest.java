...
public class WheelOfFortunePrizeBurstWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(WheelOfFortunePrizeBurstWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/WheelOfFortunePrizeBurstWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/WheelOfFortunePrizeBurstWLAIW/InitOutcome.xml").getDocumentElement();
